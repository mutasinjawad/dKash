...
const Navbar = () => {
    ...
    return (
        <header ref={headerRef} className='w-full h-[80px] leading-[80px] flex items-center bg-transparent'>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <div className="menu" ref={menuRef} onClick={toggleMenu}>
                        <ul className='flex items-center gap-10'>
                            <li><a onClick={handleClick} className='text-smallTextColor font-[600]' href="#home">Home</a></li>
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <span onClick={toggleMenu} className='text-2xl text-smallTextColor md:hidden cursor-pointer'><i class="ri-menu-3-line"></i></span>
                    </div>
                </div>
            </div>
        </header>
