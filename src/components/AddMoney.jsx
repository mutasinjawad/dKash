        ...
        <div>
            <div className='flex justify-between px-[300px] my-[80px] w-[full]'>
                ...
                <div className='flex flex-col pr-[80px]'>
                    ...
                    <button className='flex justify-center items-center mt-[30px] w-[220px] h-[59px] bg-[#e8deff] text-primaryColor font-[700] cursor-pointer rounded-full hover:bg-primaryColor hover:text-white ease-in duration-150'>Add Money</button>
                </div>
            </div>
