    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col items-center bg-[#e8deff] w-[1700px] h-[580px] mt-[20px] rounded-[50px]">
        <div className="flex flex-col items-center mb-[35px]">
          <img
            id="ProfilePic"
            className="w-[140px] rounded-full border-[7px] border-white mt-[-70px]"
            src={ProfilePicSrc ? ProfilePicSrc : defaultPic}
            alt="/"
          />
        ...
        <button
          ...
          className="flex justify-between items-center mt-[-55px] mr-[-900px] p-[18px] w-[100px] h-[49px] bg-primaryColor text-white font-[700] cursor-pointer rounded-full hover:bg-[#4c00b4] ease-in duration-150"
          href="/profile"
        >
          <i class="ri-arrow-right-circle-line"></i>Done
        </button>
      </div>
    </div>
  );
