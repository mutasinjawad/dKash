      ...
      <div className="flex justify-between px-[300px] my-[80px] w-[full]">
        <div>
          <p
            ...
            className="mb-[70px] font-[800] text-smallTextColor text-[100px]"
          >
            SEND MONEY
          </p>
        ...
        <div className="flex flex-col pr-[80px]">
          ...
          <button
            className="flex justify-center items-center mt-[30px] w-[220px] h-[59px] bg-[#e8deff] text-primaryColor font-[700]
